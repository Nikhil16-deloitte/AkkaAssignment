...
object Milestone7 extends App {
  ...
  val BulkQuantityValue=applicationConf.getString("StoreData.bqv") //getting category sink file from configuration file
  val bulkcsv = applicationConf.getString("StoreData.BulkProductInsightSinkFile")
